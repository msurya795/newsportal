...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 09, 2026 at 06:53 PM
...
(216, 1, 'admin', 'deleted a location', ' location id is 6', 0, '2026-08-09 22:17:18'),
(217, 1, 'admin', 'deleted a location', ' location id is 6', 0, '2026-08-09 22:17:19'),
(218, 1, 'admin', 'logged out', '', 0, '2026-08-09 22:22:57');
...
(1, 'admin', '9963880438', 'admin@gmail.com', '1234', 'admin', 'profilepics/pic3.jpg', 1, 1, 1, 0),
...
--
ALTER TABLE `activity_log`
  MODIFY `log_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=219;

--
-- AUTO_INCREMENT for table `category`
--
ALTER TABLE `category`
  MODIFY `cat_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `likes`
  MODIFY `like_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
