        ...
        <div class="row align-items-center bg-white py-3 px-lg-5">
            <div class="col-lg-4">
                <a href="index.html" class="navbar-brand p-0 d-none d-lg-block">
                    <h1 class="m-0 display-4 text-uppercase text-primary">Welcome<span class="text-secondary font-weight-normal">Reporter</span></h1>
                </a>
            </div>
                ...
                <div class="navbar-nav mr-auto py-0">
                   ...
                   <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="db.php?unews" class="dropdown-item">Upload news</a>
                            <a href="db.php?myn" class="dropdown-item">My News</a>
                        </div>
                    </div>
