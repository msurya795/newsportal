...
$arr=mysqli_fetch_array($result);
 if($arr['role']=='admin')
    ...
    elseif($arr['role']=='editor')
        ...
        where news_table.n_category_id='$cid' and news_table.n_location_id='$lid'and is_delete=0 and is_publish=0";
...
<table class="table table-hover table-bordered align-middle text-center mb-0">
    <thead class="table-dark">
        <tr>
            ...
            <th class="fw-bold text-uppercase">Image</th>
            <th class="fw-bold text-uppercase">Category</th>
            <th class="fw-bold text-uppercase">Location</th>
            <th class="fw-bold text-uppercase">Description</th>
            <th class="fw-bold text-uppercase">Date</th>
    ...
    <tbody>
        <tr>
            ...
            <td scope="col">
                <img src="<?php echo $row['news_image'] ?>" class="img-thumbnail rounded-3 shadow-sm" style="width:90px;height:70px;object-fit:cover;">
            </td>
            ...
            <!-- lengthy description so using button to create modal -->
            ...
            <td scope="col" class="text-nowrap">
                ...
                <a href="db.php?delnews=<?php echo $row['nid'] ?>" class="btn btn-danger btn-sm rounded-pill me-1 mb-1">
                    <i class="fas fa-trash-alt me-1"></i> Delete
                </a>

                <a href="db.php?publish=<?php echo $row['nid'] ?>" class="btn btn-success btn-sm rounded-pill me-1 mb-1">
                    <i class="fas fa-upload me-1"></i> Publish
                </a>

                <a href="db.php?editnews=<?php echo $row['nid'] ?>" class="btn btn-secondary btn-sm rounded-pill mb-1">
