        ...
        <div class="row align-items-center bg-white py-3 px-lg-5">
            <div class="col-lg-4">
                <a href="index.html" class="navbar-brand p-0 d-none d-lg-block">
                    <h1 class="m-0 display-4 text-uppercase text-primary">welcome<span class="text-secondary font-weight-normal">Member</span></h1>
                </a>
            </div>
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="db.php?profile" class="nav-item nav-link">Profile</a>
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu rounded-0">
                        <a href="db.php?vc" class="dropdown-item">comments</a>
                        <a href="db.php?mylikes" class="dropdown-item">Likes</a>
                        <a href="db.php?mb" class="dropdown-item">Bookmarks</a>
                    </div>
                </div>
