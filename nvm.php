...
$arr=mysqli_fetch_array($result);
 if($arr['role']=='admin')
    ...
    elseif($arr['role']=='editor')
        ...
        $sql2="select * from user_details where role='member' and is_verified=0 and is_deleted=0";
        $result2=mysqli_query($conn,$sql2);
?>

<h1>Non Verified Memebers</h1>
    ...
    <tbody>
        <tr>
            ...
            <td scope="col" class="text-nowrap">
                ...
                <a href="db.php?aprmember=<?php echo $row['uid'] ?>" class="btn btn-success btn-sm rounded-pill me-2 mb-1">
