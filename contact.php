            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="bg-white border border-top-0 p-4 mb-3">
                        <div class="mb-4">
                            <h5 class="text-uppercase font-weight-bold mb-4">Contact Info</h5>
							<div class="mb-3">
                        ...
                        <h5 class="mb-4">Receive messages instantly with our PHP and Ajax contact form - available in the <a href="https://htmlcodex.com/downloading/?item=1541">Pro Version</a> only.</h5>
                        <form>
                            <div class="form-row">
                                <div class="col-md-6">
