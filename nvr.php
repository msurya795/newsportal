...
$arr=mysqli_fetch_array($result);
 if($arr['role']=='admin')
    ...
    elseif($arr['role']=='editor')
        ...
        where u.role='reporter' and u.is_verified=0 and u.is_deleted=0";
    ...
    <tbody>
        <tr>
            ...
            <td scope="col" class="text-nowrap">
                ...
                <a href="db.php?aprreporter=<?php echo $row['uid'] ?>" class="btn btn-success btn-sm rounded-pill me-2 mb-1">
                    <i class="fas fa-check-circle me-1"></i>
                    Approve
                </a>

                <a href="db.php?delreporter=<?php echo $row['uid'] ?>" class="btn btn-danger btn-sm rounded-pill mb-1">
