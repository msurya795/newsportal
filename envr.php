...
$lid=$_SESSION['lid'];
 $cid=$_SESSION['cid'];
   include "editor_header.php"; 
        ...
        where u.role='reporter' and u.is_verified=0 and u.is_deleted=0 and u.cat_id='$cid' and u.loc_id='$lid'";
        $result2=mysqli_query($conn,$sql2);
        $rows = mysqli_fetch_all($result2, MYSQLI_ASSOC);
?>

<h1>Non Verified reporters</h1>
...
<table class="table table-striped table-bordered">
    ...
    <tbody>
        <tr>
            ...
            <td scope="col"><a href="db.php?eaprreporter=<?php echo $row['uid'] ?>" class="btn btn-primary">approve reporter</a> &nbsp <a href="db.php?delreporter=<?php echo $row['uid'] ?>" class="btn btn-danger">delete</a></td>
        </tr>
    </tbody>
    <?php }?>
</table>
