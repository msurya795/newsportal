...
$arr=mysqli_fetch_array($result);
 if($arr['role']=='admin')
    ...
    elseif($arr['role']=='editor')
        ...
        where u.role='editor' and u.is_verified=0 and u.is_deleted=0";
        $result2=mysqli_query($conn,$sql2);
        
        // $rows = mysqli_fetch_all($result2, MYSQLI_ASSOC);
?>

<h1>Non Verified Editors</h1>
...
<table class="table table-hover table-bordered align-middle text-center mb-0">
    ...
    <thead class="table-dark">
        <tr>
            <th class="fw-bold text-uppercase">Editor Name</th>
            <th class="fw-bold text-uppercase">Email</th>
            <th class="fw-bold text-uppercase">Mobile</th>
            <th class="fw-bold text-uppercase">Editor Category</th>
            <th class="fw-bold text-uppercase">Editor Location</th>
    ...
    <tbody>
        <tr>
            ...
            <td scope="col" class="text-nowrap">
                ...
                <a href="db.php?apreditor=<?php echo $row['uid'] ?>" class="btn btn-success btn-sm rounded-pill me-2 mb-1">
                    <i class="fas fa-check-circle me-1"></i>
                    Approve
                </a>

                <a href="db.php?deleditor=<?php echo $row['uid'] ?>" class="btn btn-danger btn-sm rounded-pill mb-1">
