    ...
    <table class="table table-striped table-bordered">
        <thead class="table-dark text-center align-middle">
            <tr>
                ...
                <th class="text-uppercase">published by</th>
        ...
        <?php foreach ($result2 as $row) { ?>
            ...
            <tbody class="align-middle">
                <tr class="text-center">
                    ...
                    <td scope="col">
                        <button data-bs-toggle="modal" data-bs-target="#description<?php echo $row['nid']; ?>" class="btn btn-outline-primary btn-sm rounded-pill px-3">
