...
$arr=mysqli_fetch_array($result);
 if($arr['role']=='admin')
    ...
    elseif($arr['role']=='editor')
        ...
        where u.role='editor' and u.is_verified=1 and u.is_deleted=0";
        $result2=mysqli_query($conn,$sql2);
        $rows = mysqli_fetch_all($result2, MYSQLI_ASSOC);
?>

<h1> Verified Editors</h1>
    ...
    <tbody>
        <tr>
            ...
            <td scope="col" class="text-nowrap">
                ...
                <a href="db.php?diseditor=<?php echo $row['uid'] ?>" class="btn btn-success btn-sm rounded-pill me-2 mb-1">
